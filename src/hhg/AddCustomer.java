...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    AddCustomer() {
        ...
        text.setForeground(new Color(167, 213, 73));
        add(text);
        ...
        lblnumber.setForeground(new Color(167, 213, 73));
        add(lblnumber);
        ...
        lblcountry.setForeground(new Color(167, 213, 73));
        add(lblcountry);
        ...
        lblroom.setForeground(new Color(167, 213, 73));
        add(lblroom);
        ...
        lbltime.setForeground(new Color(167, 213, 73));
        add(lbltime);
        ...
        lbldeposit.setForeground(new Color(167, 213, 73));
        add(lbldeposit);
        ...
        add = new JButton("ADD");
        add.setBackground(new Color(167, 213, 73));
        ...
        back.setBackground(new Color(167, 213, 73));
